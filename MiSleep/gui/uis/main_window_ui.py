...
class Ui_MiSleep(object):
    def setupUi(self, MiSleep):
        ...
        self.HyponArea = QtWidgets.QListView(self.centralwidget)
        self.HyponArea.setMinimumSize(QtCore.QSize(700, 100))
        self.HyponArea.setMaximumSize(QtCore.QSize(16777215, 130))
        self.HyponArea.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.HyponArea.setMovement(QtWidgets.QListView.Static)
        self.HyponArea.setObjectName("HyponArea")
        self.gridLayout_3.addWidget(self.HyponArea, 2, 0, 1, 1)
        ...
        self.SignalArea = QtWidgets.QListView(self.centralwidget)
        self.SignalArea.setMinimumSize(QtCore.QSize(700, 500))
        self.SignalArea.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.SignalArea.setFrameShadow(QtWidgets.QFrame.Sunken)
        ...
        self.MetaDock.setMinimumSize(QtCore.QSize(246, 100))
        ...
        self.ChannelDock.setMinimumSize(QtCore.QSize(255, 450))
        ...
        self.ChListView.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.ChListView.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectItems)
        self.ChListView.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        ...
        self.AnnotationDock.setMinimumSize(QtCore.QSize(262, 154))
